...
public class CreateQuintaHandler(IQuintaRepository repo) : IRequestHandler<CreateQuintaCommand, Guid>
{
    ...
    {
        var quinta = Quinta.Crear(cmd.Nombre, cmd.Descripcion, cmd.PrecioPorDia, cmd.Capacidad, cmd.PropietarioId, cmd.Imagenes, cmd.Direccion, cmd.Latitud, cmd.Longitud, pileta: cmd.Pileta, parrilla: cmd.Parrilla, amenities: cmd.Amenities);
